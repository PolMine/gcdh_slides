...
## Ego-Networks | Leipzig Corpus Miner (LCM) {.vcenter}

<img src="https://ablaette.github.io/gcdh_slides/img/maas_kind.png" height = "50%" width = "50%"/>


## "Wuchern der Rhizome" | (Joachim Scharloth) {.vcenter}
...
* [threedimensional gradget I](https://ablaette.github.io/gcdh_slides/widget_1.html)
* [threedimensional, anaglyph gradget II](https://ablaette.github.io/gcdh_slides/widget_2.html)
* [threedimensional, anaglyph gradget III (restrictive filtering)](https://ablaette.github.io/gcdh_slides/widget_3.html)
...
- There is a (somewhat surprising) explicit politeness in the speeches of AfD speakers.
